...
/**
 * Gets one dev-note by id from the dev-notes SQLite memory database. (GET)
 *
 * This adapter owns the SQL mapping from its internal table layout to the public dev-note shape.
...
/**
 * Searches dev-notes by partial text in the dev-notes SQLite memory database. (GET)
 *
...
/**
 * Creates a dev-note in the dev-notes SQLite memory database. (POST)
 *
